        ...
        <div className="min-h-[calc(100vh-64px)]  lg:px-14 sm:px-8 px-4">
            <div className="lg:flex-row flex-col    lg:py-5   pt-16   lg:gap-10 gap-8 flex justify-between items-center">
                <div className=" flex-1">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <motion.button
                            ...
                            transition={{ duration: 0.8 }}
                             onClick={dashBoardNavigateHandler}
                            className='border-btnColor border w-40 text-btnColor rounded-md  py-2'>Create Short Link</motion.button>
                    </div>
                </div>
                <div className='flex-1 flex justify-center w-full'>
                    <motion.img
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className='sm:w-[480px] w-[400px] obkject-cover rounded-md'
                        src='/images/img2.png'
                        alt="" />
                </div>
            </div>
            <div className="sm:pt-12 pt-7">
                <motion.p
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className='text-slate-800 font-roboto font-bold lg:w-[60%]  md:w-[70%] sm:w-[80%] mx-auto text-3xl text-center'>Trusted by individuals and teams at the world best companies</motion.p>
